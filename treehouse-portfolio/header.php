...
<html class="no-js" lang="en">
  <head>
    ...
    <?php wp_head(); ?><!-- Le dice a WP que esta a punto de encontrarse con el cierre de la etiqueta </head> y cargara todos los estilos y js que se configuraron en functions.php | For your site to work properly with WordPress and plugins-->
  </head>
